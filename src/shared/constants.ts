...
export const FS_PATHS = {
    USER_SKILLS_DIR: '~/.hamuna/skills/',
    USER_COMMANDS_DIR: '~/.hamuna/commands/',
    PROJECT_SKILLS_DIR: '.claude/skills/',
    PROJECT_COMMANDS_DIR: '.claude/commands/',
    USER_AGENTS_DIR: '~/.hamuna/agents/',
...
export const CUSTOM_EVENTS = {
    ...
    /** Fired to launch AI bug report: opens new Chat tab with ~/.hamuna workspace */
