...
const EDGE_TTS_RESULT = [
  '语音已生成。',
  '',
  'filePath: /Users/me/.hamuna/generated_audio/tts_abc12345.mp3',
...
const GEMINI_RESULT = [
  ...
  'filePath: /Users/me/.hamuna/generated/imgctx_abcd_0.png',
...
describe('parseBuiltinMediaToolResult', () => {
  ...
  it('handles windows absolute paths (drive colon in value)', () => {
    const win = EDGE_TTS_RESULT.replace(
      '/Users/me/.hamuna/generated_audio/tts_abc12345.mp3',
      'C:\\Users\\me\\.hamuna\\generated_audio\\tts_abc12345.mp3',
    );
