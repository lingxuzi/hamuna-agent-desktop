...
const detail: SpaceIssueDetail = {
  ...
  comments: {
    items: [
      {
        id: 'comment-1',
        author: { id: 'u-2', type: 'user', name: 'Commenter', avatarUrl: 'https://r2-public.hamuna.test/commenter.png' },
...
describe('IssueDetailDrawer', () => {
  ...
  it('uses the shared hierarchy label for a compact deep goal path', () => {
    const compactPath = '../HamunaAgent BUGFIX/Windows 系统兼容性优化';
    ...
    expect(within(goalLabel).getByText('../HamunaAgent BUGFIX')).toHaveClass('text-[var(--ink-muted)]/75');
