...
export default function CompanionWindow() {
    ...
    const onOpenHamunaAgentPreview = useCallback((path: string, options?: { displayPath?: string; initialLineNumber?: number }) => {
        if (!session.sessionId || !session.workspacePath) return;
    ...
    return (
        ...
        >
            ...
            <div className="fbw-chrome">
                ...
                <button onClick={onExpand} title={t('floatingBall.chrome.openInHamunaAgent')}>
            ...
            <FileActionProvider
                ...
                onOpenHamunaAgentPreview={onOpenHamunaAgentPreview}
            >
