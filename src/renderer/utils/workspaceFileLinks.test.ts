...
describe('resolveWorkspaceFileLinkTarget', () => {
  ...
  it('supports file URLs and percent-encoded spaces', () => {
    expect(resolveWorkspaceFileLinkTarget(
      'file:///Users/zhihu/Documents/project/HamunaAgent/docs/My%20Note.md:7',
      WORKSPACE,
    )).toEqual({
...
describe('resolveAgainstWorkspace', () => {
  it('joins a workspace-relative path to an absolute path', () => {
    expect(resolveAgainstWorkspace('hamuna_files/generated_audio/tts_x.mp3', WORKSPACE))
      .toBe('/Users/zhihu/Documents/project/HamunaAgent/hamuna_files/generated_audio/tts_x.mp3');
  });
  ...
  it('passes an already-absolute path through unchanged (posix)', () => {
    expect(resolveAgainstWorkspace('/Users/me/.hamuna/generated/x.mp3', WORKSPACE))
      .toBe('/Users/me/.hamuna/generated/x.mp3');
  });
