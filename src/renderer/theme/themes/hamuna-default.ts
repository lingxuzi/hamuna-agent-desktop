...
import './hamuna-default.css';
import stylesheetText from './hamuna-default.css?inline';
...
export const myAgentsDefaultTheme: ThemeDefinition = {
  id: 'hamuna-default',
  displayName: 'HamunaAgent Default',
  description: 'HamunaAgent warm paper / warm night visual language',
  stylesheetText,
  hero: {
    productName: 'HamunaAgent',
    slogans: {
