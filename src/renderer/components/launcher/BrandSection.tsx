 ...
 * (persisted to ~/.hamuna/thoughts/ via `thoughtCreate`), bypassing the full
...
export default memo(function BrandSection({
 ...
 // internal workspaces like `~/.hamuna`, producing a candidate list
 ...
 // workspace-bound draft state — `@hamuna_files/...` references point to
 // files in the previous workspace's `hamuna_files/`, `images[]`
 ...
 return (
  ...
  >
   {/* Marquee Hero — brand name + slogan as a centered visual group
                with the accent anchor square (inline span, since theme
   ...
   {/* Lower area: Input box with workspace selector in toolbar.
                ...
                `pb-[8vh]` bottom space without shifting the brand/input
                vertically (PRD §4.2). */}
   <div className="w-full max-w-[640px] pb-[8vh]">
