 ...
 *    (e.g. Settings panels editing `~/.hamuna/agents/...`)
 */
...
export default function FilePreviewModal({
    ...
    // (Settings panels editing `~/.hamuna/agents/...`).
     ...
     *  `~/.hamuna/...` files via direct fs writes). */
    ...
    // editing `~/.hamuna/agents/...` (which use the `onSave` prop) keep
