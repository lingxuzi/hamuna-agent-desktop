      ...
      {config.multiAgentRuntime && (
        <>
          ...
          {currentRuntime !== 'builtin' && agent && (() => {
            // Read current policy; default to 'hamuna' for backwards compat.
            ...
            // through the literal narrowing and read as default `'hamuna'`,
            ...
            const proxyMode: 'hamuna' | 'terminal' =
              rawPolicy === 'terminal' ? 'terminal' : 'hamuna';

            const onSelect = (next: 'hamuna' | 'terminal') => {
            ...
            return (
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {radio('hamuna', t('agentSettings.basics.proxyHamunaAgent'), t('agentSettings.basics.proxyHamunaAgentHint'))}
