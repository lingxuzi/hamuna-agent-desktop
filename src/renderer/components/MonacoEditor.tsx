...
export default function MonacoEditor({
    ...
    const activeTheme = useMemo(
        () => `hamuna-${safeMonacoThemeSegment(resolvedTheme.themeId)}-${safeMonacoThemeSegment(monacoTheme.name)}`,
        ...
        focusDecorationIdsRef.current = editor.deltaDecorations([], [
            {
                ...
                options: {
                    isWholeLine: true,
                    className: 'hamuna-monaco-search-focus-line',
                },
            },
        ]);
    ...
    return (
        ...
        >
            ...
            {findTooltip && createPortal(
                <div
                    className="hamuna-monaco-find-tooltip"
