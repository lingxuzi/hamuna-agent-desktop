            ...
            <div className="mt-2 space-y-3">
              ...
              <div>
                ...
                <div className="text-[var(--ink-muted)] font-mono text-xs leading-tight">
                  ...
                  <div>proxyPolicy: {diagnostics.effectiveEnv.proxyPolicy ?? 'hamuna'}</div>
                  <div>
                    HAMUNA_PROXY_INJECTED: {diagnostics.effectiveEnv.hamunaProxyInjected
              ...
              <div className="text-xs text-[var(--ink-muted)] italic">
                ...
                <code className="ml-1">hamuna diagnose runtime {diagnostics.runtime}</code>
              </div>
            </div>
          )}
        </div>
