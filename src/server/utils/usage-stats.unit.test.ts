    ...
    const stats = aggregateGlobalUsageStats([
      ...
      session('space', [
        message(
          'space-user',
          'user',
          '<system-reminder><hamuna-space-issue>secret</hamuna-space-issue></system-reminder>Visible issue update',
  ...
  it('never exposes hidden reminder payload and preserves visible or attachment triggers', () => {
    const stats = buildSessionDetailedUsageStats(session('space', [
      message(
        'hidden-user',
        'user',
        '<system-reminder><hamuna-space-issue>secret issue instructions</hamuna-space-issue></system-reminder>',
      ...
      message(
        'visible-space-user',
        'user',
        '<system-reminder><hamuna-space-issue>more secrets</hamuna-space-issue></system-reminder>Visible issue update',
