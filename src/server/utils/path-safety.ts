...
/** Trusted root for HamunaAgent-owned tool attachments (relative to $HOME). */
export const TOOL_ATTACHMENT_ROOT_REL = '.hamuna/generated/tool-attachments';
...
/**
 * Validate that `target` is inside the HamunaAgent-owned attachment root
 * (`~/.hamuna/generated/tool-attachments/...`). Used by `saveToolAttachment`
