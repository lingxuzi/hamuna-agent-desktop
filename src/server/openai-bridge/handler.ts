...
const PROMPT_CACHE_KEY_VALUE_RE = /hamuna:(?:chat_completions|responses):[a-f0-9]{32}/g;
const PROMPT_CACHE_KEY_VALUE_TEST_RE = /hamuna:(?:chat_completions|responses):[a-f0-9]{32}/;
