...
export interface BridgeConfig {
   ...
   *  When set, tool result images are saved to {workspacePath}/hamuna_files/temp/
...
export interface UpstreamConfig {
   ...
   *  bridges leave it off. `disablePromptCacheKey` / `disablePromptCacheBreakpoints`
   *  are per-token compatibility downgrade hooks owned by bridge-registry. */
  cacheAffinity?: {
    sessionId?: string;
