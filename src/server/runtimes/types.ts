...
export interface SessionStartOptions {
   ...
   * to `{ proxy: 'hamuna' }` — the legacy HamunaAgent-overrides-everything
  ...
  /**
   * Effective HamunaAgent MCP servers for runtimes that accept MCP at process
...
export interface AgentRuntime {
   ...
   * implement this; others fall back to HamunaAgent' turn-boundary queue.
   */
  steerMessage?(
