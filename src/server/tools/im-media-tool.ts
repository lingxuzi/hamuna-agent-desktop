...
// v0.2.11 in favour of the universal `hamuna im send-media` CLI command
// + the system prompt's <hamuna-cli-im-media> guidance (see
...
interface ImMediaContext {
   ...
   * file paths supplied via `hamuna im send-media` can be canonicalised
