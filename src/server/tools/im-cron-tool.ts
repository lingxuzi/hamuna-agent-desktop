...
// retired in v0.2.11 in favour of the universal `hamuna cron …` CLI
// commands + the system prompt's <hamuna-cli-cron> guidance (see
...
interface ImCronContext {
   ...
   *  ticks live-resolve credentials from `~/.hamuna/config.json` and
