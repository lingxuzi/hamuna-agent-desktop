 ...
 *
 * HamunaAgent does NOT interpret plugin components at runtime — that's the
 ...
 *
 * Validates only the fields HamunaAgent persists: `name` (required, kebab-case)
 ...
 * directory basename as the name — but HamunaAgent requires one so we can
 * persist a stable id).
 *
