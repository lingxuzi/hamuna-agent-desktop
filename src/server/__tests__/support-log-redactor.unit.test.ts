...
import { createLogRedactor } from '../../../bundled-agents/hamuna_helper/.claude/skills/support/scripts/redact-log-output.mjs';
...
describe('support log redactor', () => {
  it('removes common credentials, authorization headers, URLs, homes and multiline secrets', () => {
    const secrets = {
      ...
      databaseUrl: 'postgres://demo:database-secret@example.com/hamuna',
      mongoUri: 'mongodb://demo:mongo-secret@example.com/hamuna',
    };
    const input = [
