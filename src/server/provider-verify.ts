...
async function verifyViaSdk(
  ...
  try {
    ...
    // Use ~/.hamuna/projects/ as cwd — a dedicated app directory with guaranteed permissions.
...
export async function verifySubscription(): Promise<SubscriptionVerifyResult> {
  ...
  // of which is gated by settingSources. HamunaAgent deliberately does not host
