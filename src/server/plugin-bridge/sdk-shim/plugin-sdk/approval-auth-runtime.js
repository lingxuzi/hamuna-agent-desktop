...
// Source: openclaw/src/plugin-sdk/approval-auth-runtime.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/approval-auth-runtime.' + fn + '() not implemented in Bridge mode'); }
}
