...
// Source: openclaw/src/plugin-sdk/video-generation-core.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/video-generation-core.' + fn + '() not implemented in Bridge mode'); }
}
...
export function getVideoGenerationProvider() { _w('getVideoGenerationProvider'); return undefined; }
export function listVideoGenerationProviders() { _w('listVideoGenerationProviders'); return []; }
