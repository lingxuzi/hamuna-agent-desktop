...
// OpenClaw plugin-sdk/command-auth shim for HamunaAgent Plugin Bridge
// Provides command authorization resolution for channel plugins.
// HamunaAgent handles access control at the Rust layer, so these are permissive defaults.

/**
 * Resolve control command gate.
 * In real OpenClaw: checks access groups, authorizers, and gating modes.
 * Our shim: always allows — HamunaAgent Rust layer handles whitelist/permissions.
 */
 ...
 * HamunaAgent always allows DMs (Rust layer handles filtering).
 */
 ...
 * Returns a permissive result — HamunaAgent access control is at Rust layer.
 */
