...
// OpenClaw plugin-sdk/infra-runtime shim for HamunaAgent Plugin Bridge
 ...
 * Our shim: uses ~/.hamuna/tmp (HamunaAgent convention, always writable).
 */
export function resolvePreferredOpenClawTmpDir(options) {
  const dir = join(homedir(), '.hamuna', 'tmp');
