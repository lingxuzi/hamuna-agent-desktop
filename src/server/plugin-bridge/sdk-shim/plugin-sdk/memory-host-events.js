...
// Source: openclaw/src/plugin-sdk/memory-host-events.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/memory-host-events.' + fn + '() not implemented in Bridge mode'); }
}
