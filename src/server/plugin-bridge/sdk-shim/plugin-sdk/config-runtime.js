...
//
// HamunaAgent Plugin Bridge does not own an openclaw.json file. The authoritative
...
const CONFIG_GLOBAL_KEY = '__HAMUNA_OPENCLAW_CONFIG__';
...
export function getRuntimeConfigSourceSnapshot() { return { source: 'hamuna-plugin-bridge' }; }
