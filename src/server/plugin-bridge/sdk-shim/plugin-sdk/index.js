...
// OpenClaw plugin-sdk root shim for HamunaAgent Plugin Bridge
...
export function buildRandomTempFilePath(params) {
  ...
  const root = params.tmpDir ?? join(tmpdir(), 'hamuna-bridge-media');
...
export async function resolveSenderCommandAuthorizationWithRuntime(params) {
  ...
  // resolveSenderCommandAuthorization. In Bridge mode, HamunaAgent handles
