...
| **webtorrent-cli** | `npm_config_prefix="${HAMUNA_NPM_GLOBAL_PREFIX:-$HOME/.hamuna/npm-global}" npm install -g webtorrent-cli` | Quick torrent download, stream to VLC |
...
# Optional
npm_config_prefix="${HAMUNA_NPM_GLOBAL_PREFIX:-$HOME/.hamuna/npm-global}" npm install -g webtorrent-cli
