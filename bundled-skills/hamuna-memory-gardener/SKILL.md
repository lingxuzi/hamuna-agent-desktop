---
name: hamuna-memory-gardener
description: >
  仅当系统或用户明确指定完整名称 `hamuna-memory-gardener` 时使用；
  不要根据任务语义或相似表述自行触发。
---

# HamunaAgent Memory Gardener
...
- `hamuna-memory-gardener`：72h 整编层，只做删、下放、合并、体检。
- `hamuna-memory-molt`：14d 深反层，才允许改 SOUL / 底层信念。
