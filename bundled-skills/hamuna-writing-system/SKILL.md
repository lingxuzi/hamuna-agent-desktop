...
description: |
  商业写作系统（Hamuna Writing System）——专为中长篇连载小说、影视级短剧、高概念网文与中文通用写作打造的工业化专业创作引擎。
  深度融合五大核心方法论：
  ...
  5. 散文主干方法论（按文体分流、说话位置、材料五件规则、翻案腔清零、七遍改稿法）
  彻底根除AI写作中常见的悬浮虚假、机械降神、伤口瞬愈、战力崩塌与空洞套话。
  触发词包括但不限于：商业写作系统、写小说、开新书、商业小说、小说创作系统、小说写作流程、去AI味写小说、长篇连载、网文写作、知乎长答、论坛长帖、公众号文章、行业稿、评测、教程、人物故事、个人叙事、短文、口播、演讲稿。
---
...
> 好的散文也不是模型腔的复读机，而是**有材料、有说话位置、有判断、有中文韵律**的自然文章。
> 本系统拒绝"快餐式批量灌水"，拒绝"失控黑盒跳步"，拒绝"AI 公文腔与翻案腔"，坚持**"大纲定调、预案先行、一章一磨、活体对账"**的专业创作者工作流。
> 同一引擎，多套方法论：商业小说走影视化宪法，散文 / 知乎 / 论坛 / 行业稿走散文主干，混合文体两套并行。
...
动笔前必须先判定文体，按文体加载对应 reference：

- **商业小说 / 影视剧本 / 网文 / 连载** → 影视化宪法 + 伏笔追踪表 + 散文硬禁令（详见 `references/prose-methods.md` 第六节）
- **散文 / 知乎 / 论坛 / 公众号 / 行业稿 / 教程 / 评测 / 纪实 / 人物故事 / 个人叙事 / 短文 / 口播 / 演讲稿** → 散文主干 `references/forum-prose.md` + `references/reality-check.md`（如含事实）+ `references/formats-guide.md`（如需短形式适配）
- **混合文体**（如商业小说 + 行业设定）→ 影视化场景保留调度 + 散文段落走自然主干，两套并行

> 🔴 **CHECKPOINT · 文体分流未判定前，禁止进入阶段一正文工作**——商业小说套散文会让干货散得快，散文套影视化三件套（场景调度 / 道具质感 / 慢镜头）会让散文失去呼吸。

### 商业小说 / 影视剧本 / 网文场景下的四份基石文件
...
>
> 🔴 **CHECKPOINT · 单章正文必须遵守 `references/prose-methods.md` 第六节「成稿绝对不能出现」的完整硬禁令**（翻案腔清零 / 零破折号 / 冒号单点 / 同构排比≤2 / 抽象名词抒情清零 / 名词化清零 / 说白了清零 / 模型路标清零 / 27 个绝对禁词 / 9 个语境检查词 / 9 个抒情词 / "不仅……更是……" 句式清零）。商业小说的"影视化宪法"管场景/动作/情感物理化，散文主干管中文散文的活人感与句法净度——两者是**正交层**，必须叠加：① 阶段四门禁 1 的"反 AI 腔"使用 `references/anti-ai-lexicon.md` 顶部 absolute 段；② 落笔前必读 `references/prose-methods.md` 第一节「按文体读取」，决定当前章节属于现代白话散文 / 虚构文体 / 短内容格式中的哪一支；③ 章节交付前必跑 `python3 scripts/check_prose.py <章节.md>`，失败项清零才能进 walkthrough。
...
- [ ] **活人感硬门禁**——翻案腔清零、冒号仅引原话、零破折号、同构排比 ≤2、`references/anti-ai-lexicon.md` absolute 段并集清零。命中文本层面警告项先改稿，再交付

坚持**"一章一写，质量保证"**原则，单章正文字数通常保持在 **2200~3000字** 之间。每章撰写严格遵守《影视化写作宪法》以及 `references/prose-methods.md` 第六节的散文句法净度：
...
> **本门使用统一硬禁用项词典**：hamuna 原 14 词黑名单 + 散文主干 27 个绝对禁词 + 9 个语境检查词 + 9 个抒情词 + 翻案腔整组外衣 + 冒号/破折号/同构排比/抽象名词抒情/名词化/"说白了"/模型路标/商业黑话全部触发。完整清单见 `references/anti-ai-lexicon.md` 顶部 absolute 段 + `references/prose-methods.md` 第六节。

- [ ] **硬禁词清零**（脚本检查）：全文扫描 `python3 scripts/check_prose.py <章节.md>`，所有 hard_stop / hard_jargon / context_jargon / lyric_word / road_sign 命中项必须替换为白描写法或删去
- [ ] **结构性硬禁用项清零**（人工核验）：① 翻案腔外衣（"不是 A 而是 B" / "看似 A 实则 B" / "你以为是 A 其实是 B" / 跨句变形 / 换字变形 / 让转体 / 抬价体）—— 拆回正面陈述；② 正文零破折号（`—`/`——`/`–` 全部清除）；③ 中文冒号 `：` 仅允许引出直接原话（提示性冒号全部改写，网址/代码字段除外）；④ 同构排比 ≤2 项，第三项必须换说法；⑤ 抽象名词配具体动词的抒情句还原成"谁做了什么"
- [ ] **说明性总结清理**：禁止在文末使用"不仅……更是……"这类AI公文式概括（hamuna 原 §II.1）；末段重新摘要全文，删掉
...
**三门禁修复路由（不达标时怎么修）**：
- 门禁 1（反 AI 腔）→ `references/anti-ai-lexicon.md` 顶部 absolute 段同义词替换表 + `references/prose-methods.md` 第六节「成稿绝对不能出现」 + `references/revision-routine.md` 第五遍「清掉绝对不能出现的东西」
...
7. **不要把『影视化宪法』机械套用于散文 / 诗歌 / 纪实**——这些场景下，去掉场景调度 + 道具质感 + 慢镜头三件套，改走 `references/forum-prose.md` 的散文主干。同一引擎，多套方法论，按文体分流。脚本硬禁令（`references/prose-methods.md` 第六节）所有文体都生效。
...
### 商业小说 / 影视剧本 / 网文引擎
- 影视化宪法详见：`references/cinematographic-constitution.md`
...
### 散文主干（散文 / 知乎 / 论坛 / 公众号 / 行业 / 教程 / 评测 / 纪实 / 短文 / 口播 / 演讲）
- 散文硬禁令与按文体读取入口：`references/prose-methods.md`
- 散文主干方法论与示例：`references/forum-prose.md`
- 虚构创作章节（小说 / 故事 / 对白 / 剧本）：`references/fiction-craft.md`
- 事实核验规范（真人 / 历史 / 新闻 / 产品 / 数据）：`references/reality-check.md`
- 短形式与口语适配（短文 / 教程 / 口播 / 演讲 / 剧本 / 诗歌）：`references/formats-guide.md`
- 七遍改稿法（动笔后加载）：`references/revision-routine.md`

### 自动化
- 散文硬禁令兜底脚本：`scripts/check_prose.py`
