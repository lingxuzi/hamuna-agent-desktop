...
#### agnes-image-2.5-flash / agnes-video-2.5 多宫格人物约束

**3x3 grid 多宫格物理约束**：每格只占屏幕约 1/9（≈ 27% 宽度），AI 模型在如此小的空间内难以稳定生成完整人脸——面部细节不足、特征易失真、跨格一致性崩塌。这一限制**与具体模型无关**（适用于 agnes-image-2.5-flash、agnes-video-2.5、未来其他图/视频模型），是 3x3 多宫格拼接的物理约束，不是模型能力限制。人物出镜方式限于：
*   手部 / 手腕特写（珠宝/手表最常用）
*   下半脸（嘴唇、下颌线）
*   身体局部特写（肩颈、锁骨、腰线）
*   全身远景 / 背影 / 剪影
