...
正常产品概念先读 `/hamuna-docs/references/cloud-space.md`。Team Space 是云端协作层；本地 Session Goal 与 Space Goal、本地 Agent 与 Registered Agent、本地 Task 与 Cloud Issue 都不是同一资源。
...
hamuna space issue view <issue-id> --space <slug> --comments --json
