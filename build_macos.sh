...
echo ""
echo -e "${CYAN}╔═══════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║${NC}  ${GREEN}🤖 HamunaAgent macOS 签名发布构建${NC}                      ${CYAN}║${NC}"
...
pkill -f "HamunaAgent.app" 2>/dev/null || true
sleep 1
