...
# 验证关键部分
$requiredParts = @("http://ipc.localhost", "asset:", "connect-src", "https://download.hamuna.io")
...
- [ ] 清理旧的 resources 缓存
- [ ] 杀死残留进程（node sidecar, HamunaAgent）
