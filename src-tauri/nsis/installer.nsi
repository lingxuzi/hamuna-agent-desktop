...
Function PageReinstall
  ...
  ; HamunaAgent: Save old version string before comparison overwrites $R0
  StrCpy $R5 $R0
  ...
  ; Upgrading - HamunaAgent: swapped options so "overwrite upgrade" is default
  ${ElseIf} $R0 = 1
...
Function PageLeaveReinstall
  ...
  ${If} $R0 = 0 ; Same version, proceed
    ...
    ${Else}                    ; User chose to uninstall
      Goto reinst_uninstall
    ${EndIf}
  ${ElseIf} $R0 = 1 ; Upgrading - HamunaAgent: inverted logic due to swapped options
...
; HamunaAgent: Git for Windows installation section
