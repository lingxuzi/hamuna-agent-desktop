; English language file for HamunaAgent NSIS Installer
...
LangString alreadyInstalledLong ${LANG_ENGLISH} "HamunaAgent $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "HamunaAgent $R5 is already installed. You are about to install HamunaAgent ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
