// System tray implementation for HamunaAgent
...
/// Reads from ~/.hamuna/config.json, defaults to false if not configured.
///
/// Uses the project-canonical `app_dirs::hamuna_data_dir()` helper rather
