...
pub fn current_ui_language() -> UiLanguage {
    if let Some(dir) = crate::app_dirs::hamuna_data_dir() {
...
fn persist_to_disk(value: UiLanguage) -> Result<(), String> {
    let dir = crate::app_dirs::hamuna_data_dir()
...
pub fn t<'a>(key: &'a str, locale: SupportedLocale) -> &'a str {
    match (locale, key) {
        (SupportedLocale::ZhCn, "tray.open") => "打开 HamunaAgent",
        (SupportedLocale::ZhCn, "tray.settings") => "设置",
        (SupportedLocale::ZhCn, "tray.forceWakeLock") => "阻止电脑睡眠",
        (SupportedLocale::ZhCn, "tray.exit") => "退出",
        (SupportedLocale::ZhCn, "notification.sessionCompleteTitle") => "HamunaAgent - 任务完成",
        (SupportedLocale::ZhCn, "notification.sessionCompleteBody") => "请您查看结果",
        (SupportedLocale::ZhCn, "notification.sessionStoppedTitle") => "HamunaAgent - 任务已停止",
        (SupportedLocale::ZhCn, "notification.sessionStoppedBody") => "请您查看当前结果",
        (SupportedLocale::ZhCn, "notification.sessionErrorTitle") => "HamunaAgent - 任务失败",
        (SupportedLocale::ZhCn, "notification.sessionErrorBody") => "请您查看错误详情",
        (SupportedLocale::EnUs, "tray.open") => "Open HamunaAgent",
        ...
        (SupportedLocale::EnUs, "notification.sessionErrorTitle") => "HamunaAgent - Task failed",
